...
obj-m	:= railroad_communication.o
railroad_communication-y := src/telegram/idle.o src/telegram/locomotive.o src/telegram/magnetic.o src/telegram/reset.o
